...
import com.codewithirphan.blog.service.impl.PostService;
import com.codewithirphan.blog.services.FileService;
...
public class PostController {
    ...
    public ResponseEntity<PostDto> uploadPostImage(
        ...
        String fileName = this.postService.uploadImage(path, image);
